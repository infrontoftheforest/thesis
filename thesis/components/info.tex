...
\def\mtuLogo{styles/MTU_logo}
\def\doctype{Master's Thesis}

\def\title{Parallel Smoothed Aggregation Multigrid Methods for the Solution of Mechanics Problems}
\def\author{Stephen Ryan}
\def\examinerOne{Univ.-Prof.\ Dr.-Ing.\ Michael W. Gee}
\def\assistantAdvisor{Dr.-Ing.\ Moritz Thon}
\def\date{May 3rd, 2021}
